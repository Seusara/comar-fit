...
/**
 * Animated WebGL fluid orb. Pure canvas — no dependencies.
 * Respects prefers-reduced-motion.
 *
 * @param {number} size - Diameter in px (default 200)
 * @param {string} color - Hex color for the orb (default theme primary)
 * @param {string} className - Extra classes for the container
 */
function FluidOrb({ size = 200, color = '#00dbe9', className = '' }) {
